...
?>?option=com_phd&controller=applicant&task=download_file&person=<?php echo $this->applicant->id; ?>&file=<?php echo $this->applicant->career_breaks_filename; ?>'
					target="_blank"><?php echo JText::_('LABEL_DOWNLOAD'); ?> </a> <?php /*
...
<table width='100%' border='0' class="table">
	...
	<tr>
		...
		?> <a
			href='<?php echo $_SERVER['PHP_SELF'];
?>?option=com_phd&controller=applicant&task=download_file&person=<?php echo $this->applicant->id; ?>&file=<?php echo $referee->filename; ?>'
			target="_blank"><?php echo $referee->filename; ?> </a> <?php
